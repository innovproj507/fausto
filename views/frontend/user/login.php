<?php 
ob_start(); 
$title = 'Iniciar Sesión - Fausto Salazar, S.A.';
?>
    ...
    <div class="max-w-md mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-secondary">Iniciar Sesión</h2>
            ...
            <div class="text-center pt-4 border-t">
                <p class="text-gray-600">
                    ¿No tienes cuenta? 
                    <a href="<?= url('/account/register') ?>" class="text-primary hover:underline font-semibold">
                        Regístrate aquí
                    </a>
                </p>
            </div>
